...
#  value       = module.nonprod_ec2.web_eip[0].public_ip
#
#  // This output waits for the Elastic IPs to be created and distributed
#  depends_on = [module.nonprod_ec2.web_eip]
#}
#
...
#  // We are grabbing it from the Elastic IP
#  value       = module.nonprod_ec2.web_eip[0].public_dns
#
#  depends_on = [module.nonprod_ec2.web_eip]
#}
#
...
#  value       = module.nonprod_postgres.database_endpoint
#}
#
#// This will output the database port
#output "database_port" {
#  description = "The port of the database"
#  value       = module.nonprod_postgres.database_port
#}